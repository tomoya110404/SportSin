...
//*************************************************************
// Rule
//1.  use App\Http\Requests\UserGroupsValidation; //Add Controller
//2.  public function store( UserGroupsValidation $request ){ //example
//*************************************************************

class UserGroupsValidation extends FormRequest
{
    /**
