...
//*************************************************************
// Rule
//1.  use App\Http\Requests\UserTagsValidation; //Add Controller
//2.  public function store( UserTagsValidation $request ){ //example
//*************************************************************

class UserTagsValidation extends FormRequest
{
    /**
